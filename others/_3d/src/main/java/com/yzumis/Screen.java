...
public class Screen extends JPanel implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener{
    ...
    double VertLook = -0.9, HorLook = 0, aimSight = 4, HorRotSpeed = 900, VertRotSpeed = 2200;
    ...
    public Screen()
    {
        ...
        invisibleMouse();
        DPolygons.add(new DPolygon(new double[]{0, 1, 0}, new double[]{0, 0, 1}, new double[]{0, 0, 0}, Color.YELLOW));
